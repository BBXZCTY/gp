...
public class MethodInvokeTest {
    public static void main(String[] args) throws NoSuchMethodException, InvocationTargetException, IllegalAccessException {
        ...
        //InvokeObj类的stringIntShow()方法：
        System.out.println("InvokeObj类的stringIntShow()方法：");
        Method method6=clazz.getMethod("stringIntShow", String.class, Integer.class);
        method6.invoke(new InvokeObj(), "tom", 30);
